...
export declare const Controls: {
    registerEx: typeof registerEx;
    get: typeof get;
    getDescription: typeof getDescription;
    getVersion: typeof getVersion;
    getBasePath: typeof getBasePath;
    getBasePathEx: typeof getBasePathEx;
    getMap: typeof getMap;
    limitPixelDimensionToControlBound: typeof limitPixelDimensionToControlBound;
};
...
export declare const Functions: {
    ...
    getFunctionVersion: typeof getFunctionVersion;
    registerFunctionEx: typeof registerFunctionEx;
};
